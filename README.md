...
La idea principal es demostrar cómo Kafka permite desacoplar los servicios y manejar eventos en tiempo real, algo muy común en arquitecturas distribuidas modernas, por ejemplo cuando un servicio de pagos genera un evento
y otros servicios (como notificaciones o auditoría) reaccionan sin necesidad de una llamada directa.
